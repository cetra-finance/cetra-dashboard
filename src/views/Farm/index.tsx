...
const Farm: FC<FarmProps> = ({ onLoaded }) => {
    ...
    const burnAmount = (currentUsdAmount as BigNumber).isZero()
        ? BigNumber.from("0")
            ...
            <SimpleGrid gap="22px">
                ...
                <Stack direction="column" spacing="5px">
                    ...
                    <Stack
                        ...
                        pb="4px"
                    >
                        <Image src={state.depositAssetIcon} w="29px" h="29px" />
                        <Input
                            variant="unstyled"
                            type="number"
                            color="#1F2040"
                    ...
                    <Stack direction="row" spacing="30px">
                        ...
                        >
                            ...
                            <Text
                                ...
                                fontWeight="medium"
                            >
                                {cardInfo.amountToSwap[1]} {state.baseAssetName}
                            </Text>
                        </Stack>
                    </Stack>
                </Stack>
